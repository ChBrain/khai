...
Has and Loses are the trade. Orders and Drives are the instruction and the direction. A position file succeeds when the trade is real enough that the direction toward the goal carries forward without being chosen.
