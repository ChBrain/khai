...
Initiated by and Echo are the frame. Direction and Lever are the physics. A process file succeeds when the threshold is real enough that crossing it changes what the next process inherits.
