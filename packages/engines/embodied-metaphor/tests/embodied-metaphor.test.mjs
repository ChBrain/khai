...
describe("embodied-metaphor: conforms to the canon", () => {
  it("the whole package validates (content + manifest + compose)", async () => {
    expect(flatten(await validateEnginePackage(pkgDir, { executeCompose: true }))).toEqual([]);
  });
});

describe("embodied-metaphor: manifest", () => {
  it("declares the position engine over the five primary metaphors", () => {
    expect(manifest.engine).toBe("embodied-metaphor");
    expect(manifest.type).toBe("position");
    expect(manifest.anchor).toBe("position_embodied_metaphor.md");
...
describe("embodied-metaphor: compose()", () => {
