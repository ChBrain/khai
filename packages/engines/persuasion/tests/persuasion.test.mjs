...
describe("persuasion: conforms to the canon", () => {
...
describe("persuasion: manifest", () => {
  it("declares the persuasion process engine", () => {
    expect(manifest.engine).toBe("persuasion");
    expect(manifest.type).toBe("process");
    expect(manifest.members).toHaveLength(5);
    expect(manifest.members.find((m) => m.parent === null).file).toBe("process_persuasion.md");
  });
...
describe("persuasion: compose()", () => {
  const root = "Process: Persuasion";
