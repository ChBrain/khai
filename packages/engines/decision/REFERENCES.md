...
| **Amos Tversky &amp; Daniel Kahneman** | _"Judgment under Uncertainty: Heuristics and Biases"_ (1974) | **Spine (heuristics as economical shortcuts).** Heuristics as cognitive shortcuts that are usually efficient and systematically wrong in predictable ways. |
