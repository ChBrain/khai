// The mortality engine tests only what is mortality-specific: that the package
...
// --- self-conformance: mortality certifies itself against the canon ---------
describe("mortality: conforms to the canon", () => {
...
// --- manifest contract ----------------------------------------------------
describe("mortality: manifest", () => {
  it("declares the mortality position engine", () => {
    expect(manifest.engine).toBe("mortality");
    expect(manifest.type).toBe("position");
    expect(manifest.anchor).toBe("position_mortality.md");
...
describe("mortality: compose()", () => {
  ...
  it("rejects an unknown expression", () => {
    expect(() => compose({ expression: "not-a-mortality" })).toThrow();
  });
