// The debt engine tests only what is debt-specific: that the package
...
describe("debt: conforms to the canon", () => {
...
describe("debt: manifest", () => {
  it("declares the debt engine rooted on a piece", () => {
    expect(manifest.engine).toBe("debt");
    expect(manifest.type).toBe("piece");
    expect(manifest.members).toHaveLength(6);
    const root = manifest.members.find((m) => m.parent === null);
    expect(root.file).toBe("piece_debt.md");
  });
