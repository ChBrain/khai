...
- **Attention**: The engine models the baseline temporal frame, not the attentional mechanisms that affect duration as a downstream consequence. How the spotlight is allocated, and how allocation affects felt interval length, is governed by the attention engine; this engine governs the frame in which the spotlight operates.
- **Memory**: The engine models the felt availability of past and future as a resting orientation, not the reconstruction of specific past events. How the past is held and retrieved -- episodic, semantic, prospective -- is owned by the memory engine; this engine governs whether the past and future carry felt weight as a matter of position.
...
- **[time-perception](position_time_perception.md)** (the anchor): The baseline temporal orientation -- felt duration, the weight of the future, the availability of the past. Anchored by Barkley (temporal frame as a baseline property) and Wittmann (duration as embodied, felt process).
