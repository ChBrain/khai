...
describe("capitalization: conforms to the canon", () => {
  it("the whole package validates (content + manifest + compose)", async () => {
    expect(flatten(await validateEnginePackage(pkgDir, { executeCompose: true }))).toEqual([]);
  });
});

describe("capitalization: manifest", () => {
  it("declares the position engine over the four response styles", () => {
    expect(manifest.engine).toBe("capitalization");
    expect(manifest.type).toBe("position");
    expect(manifest.anchor).toBe("position_capitalization.md");
...
describe("capitalization: compose()", () => {
