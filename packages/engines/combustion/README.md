...
- [combustion](process_combustion.md): process (anchor)
- [crown](process_crown.md): process
- [grass](process_grass.md): process
- [chaparral](process_chaparral.md): process
- [peat](process_peat.md): process
- [holdover](process_holdover.md): process
