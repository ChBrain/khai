// The self-efficacy engine tests only what is self-efficacy-specific: that
// the package conforms to the canon through the shared conformance kit
...
// --- self-conformance: self-efficacy certifies itself against the canon ---
describe("self-efficacy: conforms to the canon", () => {
...
// --- manifest contract ----------------------------------------------------
describe("self-efficacy: manifest", () => {
  it("declares the self-efficacy position engine", () => {
    expect(manifest.engine).toBe("self-efficacy");
    expect(manifest.type).toBe("position");
    expect(manifest.anchor).toBe("position_self_efficacy.md");
...
describe("self-efficacy: compose()", () => {
  ...
  it("rejects an unknown expression", () => {
    expect(() => compose({ expression: "not-a-self-efficacy" })).toThrow();
  });
