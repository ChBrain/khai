...
describe("role: conforms to the canon", () => {
...
describe("role: manifest", () => {
  it("declares the role position engine", () => {
    expect(manifest.engine).toBe("role");
    expect(manifest.type).toBe("position");
    expect(manifest.anchor).toBe("position_role.md");
...
describe("role: compose()", () => {
  ...
  it("rejects an unknown expression", () => {
    expect(() => compose({ expression: "not-a-role" })).toThrow();
  });
