// The money engine tests only what is money-specific: that the package
...
describe("money: conforms to the canon", () => {
...
describe("money: manifest", () => {
  it("declares the money engine rooted on a piece", () => {
    expect(manifest.engine).toBe("money");
    expect(manifest.type).toBe("piece");
    expect(manifest.members).toHaveLength(4);
    const root = manifest.members.find((m) => m.parent === null);
    expect(root.file).toBe("piece_money.md");
  });
