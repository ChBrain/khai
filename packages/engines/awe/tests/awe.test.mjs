// The awe engine tests only what is awe-specific: that the package
...
describe("awe: conforms to the canon", () => {
...
describe("awe: manifest", () => {
  it("declares the awe engine and its anchor", () => {
    expect(manifest.engine).toBe("awe");
    expect(manifest.members).toHaveLength(5);
    const root = manifest.members.find((m) => m.parent === null);
    expect(root.file).toBe("process_awe.md");
  });
