...
describe("achievement-motive: conforms to the canon", () => {
  it("the whole package validates (content + manifest + compose)", async () => {
    expect(flatten(await validateEnginePackage(pkgDir, { executeCompose: true }))).toEqual([]);
  });
});

describe("achievement-motive: manifest", () => {
  it("declares the position engine over the two motives", () => {
    expect(manifest.engine).toBe("achievement-motive");
    expect(manifest.type).toBe("position");
    expect(manifest.anchor).toBe("position_achievement_motive.md");
...
describe("achievement-motive: compose()", () => {
