// The hope engine tests only what is hope-specific: that the package
...
// --- self-conformance: hope certifies itself against the canon ---------
describe("hope: conforms to the canon", () => {
...
// --- manifest contract ----------------------------------------------------
describe("hope: manifest", () => {
  it("declares the hope position engine", () => {
    expect(manifest.engine).toBe("hope");
    expect(manifest.type).toBe("position");
    expect(manifest.anchor).toBe("position_hope.md");
...
describe("hope: compose()", () => {
  ...
  it("rejects an unknown expression", () => {
    expect(() => compose({ expression: "not-a-hope" })).toThrow();
  });
