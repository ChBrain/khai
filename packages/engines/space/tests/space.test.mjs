...
describe("space: conforms to the canon", () => {
...
describe("space: manifest", () => {
  it("declares the space place engine: anchor plus three expressions", () => {
    expect(manifest.engine).toBe("space");
    expect(manifest.type).toBe("place");
    expect(manifest.anchor).toBe("place_space.md");
