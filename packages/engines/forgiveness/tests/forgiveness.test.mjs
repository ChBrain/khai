// The forgiveness engine tests only what is forgiveness-specific: that the package
...
describe("forgiveness: conforms to the canon", () => {
...
describe("forgiveness: compose()", () => {
  for (const leaf of Object.keys(chains)) {
    it(`composes ${leaf}: anchor first`, () => {
      const out = compose({ leaf });
      expect(out.trimStart().split("\n")[0]).toBe("# Process: Forgiveness");
    });
  }
