// The totem engine tests only what is totem-specific: that the package
...
describe("totem: conforms to the canon", () => {
...
describe("totem: manifest", () => {
  it("declares the totem engine rooted on a piece", () => {
    expect(manifest.engine).toBe("totem");
    expect(manifest.type).toBe("piece");
    expect(manifest.members).toHaveLength(4);
    const root = manifest.members.find((m) => m.parent === null);
    expect(root.file).toBe("piece_totem.md");
  });
