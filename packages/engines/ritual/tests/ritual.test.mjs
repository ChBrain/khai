...
describe("ritual: conforms to the canon", () => {
...
describe("ritual: manifest", () => {
  it("declares the ritual process engine", () => {
    expect(manifest.engine).toBe("ritual");
    expect(manifest.type).toBe("process");
    expect(manifest.members).toHaveLength(5);
    expect(manifest.members.find((m) => m.parent === null).file).toBe("process_ritual.md");
  });
...
describe("ritual: compose()", () => {
  const root = "Process: Ritual";
