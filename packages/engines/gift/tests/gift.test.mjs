...
describe("gift: conforms to the canon", () => {
...
describe("gift: manifest", () => {
  it("declares the gift process engine", () => {
    expect(manifest.engine).toBe("gift");
    expect(manifest.type).toBe("process");
    expect(manifest.members).toHaveLength(4);
    expect(manifest.members.find((m) => m.parent === null).file).toBe("process_gift.md");
  });
...
describe("gift: compose()", () => {
  const root = "Process: Gift";
