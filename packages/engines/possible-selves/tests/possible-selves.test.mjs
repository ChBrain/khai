...
describe("possible-selves: conforms to the canon", () => {
  it("the whole package validates (content + manifest + compose)", async () => {
    expect(flatten(await validateEnginePackage(pkgDir, { executeCompose: true }))).toEqual([]);
  });
});

describe("possible-selves: manifest", () => {
  it("declares the possible-selves position engine over the four standings", () => {
    expect(manifest.engine).toBe("possible-selves");
    expect(manifest.type).toBe("position");
    expect(manifest.anchor).toBe("position_possible_selves.md");
...
describe("possible-selves: compose()", () => {
