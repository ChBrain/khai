...
Straight through, toward restitution.
Because neither the authorship nor the injury is contested, the account clears the accounting phase in the fewest passes; there is nothing left to align between the two versions, only the amends still waiting to be offered.
The vector runs forward into what happens next, not backward into re-litigating what already happened.
