// The flow engine tests only what is flow-specific: that the package
...
describe("flow: conforms to the canon", () => {
...
describe("flow: manifest", () => {
  it("declares the flow process engine and its root", () => {
    expect(manifest.engine).toBe("flow");
    expect(manifest.type).toBe("process");
    expect(manifest.members).toHaveLength(4);
    const root = manifest.members.find((m) => m.parent === null);
    expect(root.file).toBe("process_flow.md");
  });
