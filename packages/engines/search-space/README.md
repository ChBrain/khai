...
The Search Space as place and piece: the computational complexity limits (P, NP, NP-complete, NP-hard, and PPAD) and the classic optimization problems that bear their weight.
...
- [the search space](place_the_search_space.md): place (anchor)
- [p](place_p.md): place
- [the path](piece_the_path.md): piece
