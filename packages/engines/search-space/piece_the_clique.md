...
[Packing](place_packing.md). The Clique problem, representing mutually compatible choices.
...
Located in the Packing chamber, [Packing](place_packing.md), where nodes are clustered together.
...
Proven NP-complete by Richard Karp in 1972 as one of his original 21 problems. It carries the history of social network analysis, bioinformatics clustering, and the theoretical study of graph complexity.
