// The wow engine tests only what is wow-specific: that the package
...
describe("wow: conforms to the canon", () => {
...
describe("wow: manifest", () => {
  it("declares the wow engine and its anchor", () => {
    expect(manifest.engine).toBe("wow");
    expect(manifest.members).toHaveLength(15);
    const root = manifest.members.find((m) => m.parent === null);
    expect(root.file).toBe("process_wow.md");
  });
