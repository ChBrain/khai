// The stigma engine tests only what is stigma-specific: that the package
...
describe("stigma: conforms to the canon", () => {
...
describe("stigma: manifest", () => {
  it("declares the stigma engine rooted on a piece", () => {
    expect(manifest.engine).toBe("stigma");
    expect(manifest.type).toBe("piece");
    expect(manifest.members).toHaveLength(4);
    const root = manifest.members.find((m) => m.parent === null);
    expect(root.file).toBe("piece_stigma.md");
  });
