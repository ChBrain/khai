...
- [decay](process_decay.md): process (anchor)
- [rust](process_rust.md): process
- [rot](process_rot.md): process
- [crumble](process_crumble.md): process
- [patina](process_patina.md): process
