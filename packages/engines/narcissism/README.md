...
Narcissism as a multi-type engine: the entitled self-importance a persona defends -- across the grandiose, vulnerable, communal, and malignant types (position), the shared self-regulation of admiration, rivalry, and injury (process), and the differing aims each type pursues (plan).
...
- [narcissism](position_narcissism.md): position (anchor)
- [grandiose](position_grandiose.md): position
