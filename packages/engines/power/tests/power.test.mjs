...
describe("power: conforms to the canon", () => {
...
describe("power: manifest", () => {
  it("declares the power position engine", () => {
    expect(manifest.engine).toBe("power");
    expect(manifest.type).toBe("position");
    expect(manifest.anchor).toBe("position_power.md");
...
describe("power: compose()", () => {
  ...
  it("rejects an unknown expression", () => {
    expect(() => compose({ expression: "not-a-power" })).toThrow();
  });
