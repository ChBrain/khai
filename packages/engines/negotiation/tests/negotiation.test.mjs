...
describe("negotiation: conforms to the canon", () => {
...
describe("negotiation: manifest", () => {
  it("declares the negotiation process engine", () => {
    expect(manifest.engine).toBe("negotiation");
    expect(manifest.type).toBe("process");
    expect(manifest.members).toHaveLength(5);
    expect(manifest.members.find((m) => m.parent === null).file).toBe("process_negotiation.md");
  });
...
describe("negotiation: compose()", () => {
  const root = "Process: Negotiation";
