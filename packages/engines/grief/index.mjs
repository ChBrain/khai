// Entry point for the grief engine. Reads the declarative `khai` manifest
 ...
 *
 * @param {{ leaf: string }} opts  leaf is a member file, e.g. "process_yearning.md"
...
export function compose({ leaf } = {}) {
  ...
  if (!chain) {
    ...
    throw new Error(
      `khai-engine-grief: compose() needs { leaf } to be one of [${valid}]; got ${JSON.stringify(leaf)}`,
    );
  }
