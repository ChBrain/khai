...
describe("narrative: conforms to the canon", () => {
...
describe("narrative: manifest", () => {
  it("declares the narrative position engine", () => {
    expect(manifest.engine).toBe("narrative");
    expect(manifest.type).toBe("position");
    expect(manifest.anchor).toBe("position_narrative.md");
...
describe("narrative: compose()", () => {
  ...
  it("rejects an unknown expression", () => {
    expect(() => compose({ expression: "not-a-narrative" })).toThrow();
  });
