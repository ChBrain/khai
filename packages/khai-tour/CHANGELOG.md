...
- af4de70: findFiles returns POSIX-separated paths, so a bundle's section order no longer
  depends on the operating system that built it.
- ae88d72: Every interactive venue is upload-oriented, and repo-attachability is a separate
  fact.
