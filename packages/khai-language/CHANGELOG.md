...
- 65f0fc1: Delete `tagline` from the scanned chapter set: it was never a chapter.
...
- 733fb96: Accept BCP-47 private-use subtags, for the varieties no registry names.
...
- 06c1c91: The language gate reads the canon's chapters, not a hand-typed list.
...
- 12fae8a: Migrate js-yaml to v5 in governance lane (2/4). js-yaml 5 removed the default export; switched to namespace import `import * as yaml` and bumped the dependency to ^5.1.0 in @chbrain/khai-rules and @chbrain/khai-language.
