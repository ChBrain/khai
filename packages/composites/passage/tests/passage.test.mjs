// The passage composite tests only what is composite-specific: canon
...
describe("passage: conforms to the canon", () => {
...
describe("passage: the atoms arrive with the package", () => {
  it("re-exports the two dependency engines", () => {
    expect(Object.keys(atoms).sort()).toEqual(["liminality", "ritual"]);
...
describe("passage: compose()", () => {
  for (const leaf of Object.keys(chains)) {
    it(`composes ${leaf}: root first`, () => {
      const out = compose({ leaf });
      expect(out.trimStart().split("\n")[0]).toBe("# Process: Passage");
    });
  }
