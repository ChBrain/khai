// The resilience composite tests only what is composite-specific: canon
...
describe("resilience: conforms to the canon", () => {
...
describe("resilience: the atoms arrive with the package", () => {
  it("re-exports the two dependency engines", () => {
    expect(Object.keys(atoms).sort()).toEqual(["coping", "stress"]);
...
describe("resilience: compose()", () => {
  for (const leaf of Object.keys(chains)) {
    it(`composes ${leaf}: root first`, () => {
      const out = compose({ leaf });
      expect(out.trimStart().split("\n")[0]).toBe("# Process: Resilience");
    });
  }
