// The comic composite tests only what is composite-specific: canon
...
describe("comic: conforms to the canon", () => {
...
describe("comic: the atoms arrive with the package", () => {
  it("re-exports the three dependency engines", () => {
    expect(Object.keys(atoms).sort()).toEqual(["emotion", "humor", "surprise"]);
