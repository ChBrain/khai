...
export function compose({ leaf } = {}) {
  ...
  if (!chain) {
    ...
    throw new Error(
      `khai-composite-moral-account: compose() needs { leaf } to be one of [${valid}]; got ${JSON.stringify(leaf)}`,
    );
  }
...
import guilt from "@chbrain/khai-engine-guilt";
import repair from "@chbrain/khai-engine-repair";
import forgiveness from "@chbrain/khai-engine-forgiveness";
import betrayal from "@chbrain/khai-engine-betrayal";

export const atoms = { guilt, repair, forgiveness, betrayal };
