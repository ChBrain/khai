// Entry point for the hate composite. Reads the declarative `khai` manifest from
...
export function compose({ leaf } = {}) {
  ...
  if (!chain) {
    ...
    throw new Error(
      `khai-composite-hate: compose() needs { leaf } to be one of [${valid}]; got ${JSON.stringify(leaf)}`,
    );
  }
...
import contempt from "@chbrain/khai-engine-contempt";

export const atoms = { disgust, anger, contempt };
