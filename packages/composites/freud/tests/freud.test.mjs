// The freud composite tests only what is composite-specific: canon conformance
...
describe("freud: conforms to the canon", () => {
...
describe("freud: the atoms arrive with the package", () => {
