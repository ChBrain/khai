// Entry point for the intergroup composite. Reads the declarative `khai`
 ...
 *
 * @param {{ leaf: string }} opts  leaf is a member file, e.g. "process_enmity.md"
...
export function compose({ leaf } = {}) {
  ...
  if (!chain) {
    ...
    throw new Error(
      `khai-composite-intergroup: compose() needs { leaf } to be one of [${valid}]; got ${JSON.stringify(leaf)}`,
    );
  }
...
export const atoms = { socialIdentity, bias, aggression };
