// The absorption composite tests only what is composite-specific: canon
...
describe("absorption: conforms to the canon", () => {
...
describe("absorption: the atoms arrive with the package", () => {
  it("re-exports the three dependency engines", () => {
    expect(Object.keys(atoms).sort()).toEqual(["attention", "flow", "time-perception"]);
...
describe("absorption: compose()", () => {
  for (const leaf of Object.keys(chains)) {
    it(`composes ${leaf}: root first`, () => {
      const out = compose({ leaf });
      expect(out.trimStart().split("\n")[0]).toBe("# Process: Absorption");
    });
  }
