// The tragic composite tests only what is composite-specific: canon
...
describe("tragic: conforms to the canon", () => {
...
describe("tragic: the atoms arrive with the package", () => {
  it("re-exports the three dependency engines", () => {
    expect(Object.keys(atoms).sort()).toEqual(["empathy", "grief", "reversal"]);
...
describe("tragic: compose()", () => {
  for (const leaf of Object.keys(chains)) {
    it(`composes ${leaf}: root first`, () => {
      const out = compose({ leaf });
      expect(out.trimStart().split("\n")[0]).toBe("# Process: Tragic");
    });
  }
