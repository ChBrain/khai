...
- Updated dependencies [85e210a]
  ...
  - @chbrain/khai-language@0.1.26

## 0.4.6

### Patch Changes

- 264fe26: `referencedIds` resolved a relative link target and nothing else, so a group
...
- 557bc2c: khai-cultures carries its own hand-rolled resolver, `tests/culture_sources.mjs`,
