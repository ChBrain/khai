...
const { classifyBranch, checkBranchScope, advise, resolveConfig, ConfigError } = guard;

// Dormant until the source PR lands the branch-scope functions. Until then these
// suites skip (so this test PR is green and can merge first under the source/test
// split); they activate and assert once `checkBranchScope` exists on main.
const DORMANT = typeof guard.checkBranchScope !== "function";
...
describe.skipIf(DORMANT)("classifyBranch", () => {
...
describe.skipIf(DORMANT)("checkBranchScope", () => {
...
describe.skipIf(DORMANT)("advise", () => {
...
describe.skipIf(DORMANT)("resolveConfig branchScope validation", () => {
