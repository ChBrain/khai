...
- 4a5bd40: The environment report runs before `npm ci`, which is when it is asked for.
...
- ea8366b: A renamed play is not a new play.
...
- b72f8fe: Make the exemption list a ratchet in both directions: `homonymGrowth` refuses an
