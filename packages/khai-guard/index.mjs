...
// npmSpawn and renderEnvironment live in environment.mjs, which imports nothing
// outside node so the report can run on a fresh clone before `npm ci`. Re-exported
// here so every existing caller keeps its import unchanged.
export { npmSpawn, renderEnvironment, reportEnvironment } from "./environment.mjs";
