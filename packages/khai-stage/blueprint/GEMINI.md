...
- If the Manager struggles to resolve a task, or tries to use tool capabilities ("antigravity powers") to reach beyond this repository's scope, the Manager must stop, step off-stage, and invoke a local dialogue with Nicias and Pericles to receive guidance.
