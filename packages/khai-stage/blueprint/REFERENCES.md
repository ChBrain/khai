...
{{SOURCE_TITLE}}'s writings, historical archives, and cultural context.

| Source               | Key Work / Event | Scope                            |
| -------------------- | ---------------- | -------------------------------- |
| **{{SOURCE_TITLE}}** | Canonical works  | Description of the source canon. |
