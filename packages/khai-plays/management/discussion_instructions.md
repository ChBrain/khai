...
The register for enacting a management discussion in this repository. It is the
management-track analog of the runtime Prose Standard: where Prose says everything
is a Scene and lets narration bridge, a discussion says everything is a discussion
and lets the dialogue carry. The voice layer (`management_instructions.md`) carries
the operative subset; this is the full register.
