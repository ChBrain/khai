...
| `shadow`          | `archetypes` keeps it (Jung's)                        | `journey-roles/persona_shadow.md`              | `shadow_role`            | matches `journey_role` beside it                                                                                                                     | 0     | building        |
| `trickster`       | `archetypes` keeps it                                 | `journey-roles/persona_trickster.md`           | `trickster_role`         | as above                                                                                                                                             | 0     | building        |
