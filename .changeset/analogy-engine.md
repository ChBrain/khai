---
"@chbrain/khai-engine-analogy": patch
---

Add the analogy engine (process: root + forms) -- reasoning by structure-mapping, aligning the relational structure of a known source with a target and carrying inferences across the alignment. The gap analysis (Tier-3 #29) found `framing`/metaphor owns the rhetorical device, but nothing owned the reasoning-and-transfer mechanism beneath a comparison.
