---
"@chbrain/khai-engine-categorization": patch
---

Add the categorization engine (process: root + forms) -- the sorting of instances into kinds and the forming of the kinds themselves. The gap analysis (Tier-3 #30) found `representativeness` _uses_ categories (to judge probability by similarity), but nothing owned their formation and structure.
